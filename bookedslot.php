...
<div class="navbar">
  ...
  <div class="gallery-dropdown">
    <select onchange="location = this.value;">
      ...
      <option value="video.html">Videos</option>
    </select>
  ...
  <a href="about.html">About Us</a> <!-- New "About Us" option -->
  <a href="contact.html">Contact Us</a> <!-- Existing "Contact Us" option -->
  <a href="bookedslot.html">Booked slot</a>
    <a href="login.html?logout=true">Log Out</a>
    
</div>
<a href="bookedslot.html" class="go-back-button">Go Back</a>
...
$mobile = $_POST['mobile'];
  ...
  // Query to retrieve data based on email and mobile number
  $sql = "SELECT * FROM booking_records WHERE email='$email' AND mobile='$mobile'";
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<p class='no-records'>No records found for the given email and mobile number.</p>";
  }
